    ...
    <div class="col-lg-12">
        ...
        <div class="card shadow border-none my-2 px-2">
            ...
            <div class="card-body px-0 pb-2 mt-3">
                <form action="<?= site_url('staff/store') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="row">
                        ...
                        <div class="mb-3 col-3">
                            <label>
                                <input type="checkbox" name="create_user" value="yes"> Create Login Account
                            </label>
                        </div>

                        <div class="mb-3 col-9">
                            <label for="password">Password (if creating user)</label>
