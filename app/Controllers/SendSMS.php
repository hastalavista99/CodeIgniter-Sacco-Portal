...
class SendSMS extends BaseController
{
    public function sendSMS($mobile, $msg)
    {
        ...
        $partnerid = $_SERVER['SMS_PARTNER_ID'];
        ...
        //         curl_close($ch);
        //         return redirect()->back()->with('fail', 'Successful but SMS failed to send. Please try again later');
        //     }
        ...
        //         return redirect()->back()->with('fail', 'Saved but SMS failed to send');
        //     }
        // } else {
    ...
    public function sendOTP($mobile, $msg)
    {
        ...
        // if (!empty($msg) && !empty($mobile)) {
        //     $msg = urlencode($msg);
        //     $finalURL = "https://send.macrologicsys.com/api/services/sendotp?apikey=$apikey&partnerID=$partnerid&message=$msg&shortcode=$senderid&mobile=$mobile";
