                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-2 pb-2">
                                        ...
                                        <p class="text-center small">Please fill all fields to proceed.</p>
                                    </div>
                                    <?php
                                    $userId = session()->get('userId');
                                    ?>
                                    <form action="<?= site_url('renew/password?user=' . $userId) ?>" class="row g-3 needs-validation" method="post">
                                        <?= csrf_field() ?>
                                        ...
                                        <div class="form-floating mb-1 col-12">
                                            <input type="password" name="password" id="newPassword" class="form-control " placeholder="Username Here" required>
                                        ...
                                        <div class="form-floating mb-1 col-12">
                                            <input type="password" name="passwordConf" id="renewPassword" class="form-control " placeholder="Username Here" required>
                                ...
                                document.getElementById('checkPassword').addEventListener('change', function() {
                                    let passwordFields = document.querySelectorAll('#newPassword, #renewPassword');
